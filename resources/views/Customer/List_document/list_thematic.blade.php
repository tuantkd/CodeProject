...
@section('title', 'Báo cáo chuyên đề')
...
@section('noidung_tailieu')
	...
	<div class="row">
		...
		<form class="form-inline" method="GET" action="{{ route('view_list_thematic') }}">
			{{ csrf_field() }}
		    <div class="text-left">
				...
				<div class="col-xs-11 col-sm-11 col-md-3 col-lg-3">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<a href="view_detail_document{{ $thematic->id }}" id="link_a">
								<img src="{{ asset('public/upload_file_images/' 
								.$thematic->file_cover_image) }}"
						...
						<div class="panel-footer">
							...
							<div class="text-right">
		                    	...
		                    	{!! date("d-m-Y", strtotime($thematic->updated_at)) !!}
							</div>
		...
		@if(isset($thematics))
			<nav>
			    <ul class="pagination justify-content-end"> 
			        {{ $thematics->links('vendor.pagination.bootstrap-4') }}
			    </ul>
			</nav>
		@endif
	</div>
