...
@section('noidung_tailieu')
	...
	<div class="row">
		...
		action="{{ route('view_list_curriculum') }}">
			{{ csrf_field() }}
		    <div class="text-left">
				...
				<div class="col-xs-11 col-sm-11 col-md-3 col-lg-3">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<a href="view_detail_document{{ $curriculum->id }}" id="link_a">
								<img src="{{ asset('public/upload_file_images/' 
								.$curriculum->file_cover_image) }}"
			                    class="img-responsive" alt="khai giảng" id="img_sach"><br>
								{{ $curriculum->title_file }}
							</a>
						...
						<div class="panel-footer">
							...
							<div class="text-right">
		                    	...
		                    	{!! date("d-m-Y", strtotime($curriculum->updated_at)) !!}
							</div>
		...
		@if(isset($curriculums))
			<nav>
			    <ul class="pagination justify-content-end"> 
			        {{ $curriculums->links('vendor.pagination.bootstrap-4') }}
			    </ul>
			</nav>
		@endif
	</div>
