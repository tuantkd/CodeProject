...
@section('title', 'Thông tin bài báo khoa học')
...
@section('noidung_tailieu')
	...
	<div class="row">
		...
		<form class="form-inline" method="GET" action="{{ route('view_list_science') }}">
			{{ csrf_field() }}
		    <div class="text-left">
				...
				<div class="col-xs-11 col-sm-11 col-md-3 col-lg-3">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<a href="view_detail_document{{ $science->id }}" id="link_a">
								<img src="{{ asset('public/upload_file_images/' 
								.$science->file_cover_image) }}"
						...
						<div class="panel-footer">
							...
							<div class="text-right">
		                    	...
		                    	{!! date("d-m-Y", strtotime($science->updated_at)) !!}
							</div>
		...
		@if(isset($sciences))
			<nav>
			    <ul class="pagination justify-content-end"> 
			        {{ $sciences->links('vendor.pagination.bootstrap-4') }}
			    </ul>
			</nav>
		@endif
	</div>
