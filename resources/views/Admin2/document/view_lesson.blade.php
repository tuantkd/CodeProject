  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="text-right">
          <a class="btn btn-primary" href="{!! URL::to('get_add_lesson_admin') !!}"
          role="button">
        ...
        <div class="card mb-3">
          <div class="card-header" id="card-header">
            <h4><i class="fas fa-table"></i>&nbsp;Tài liệu bài giảng</h4>
          </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <?php $i=1; ?>
                    @if(isset($data_lesson))
                    @foreach($data_lesson as $document)
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        href="get_edit_lesson{!! $document->id !!}" role="button">
                      ...
                      <td>
                        ...
                        href="get_delete_lesson{!! $document->id !!}"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <nav>
                    <ul class="pagination justify-content-end">
                         {{ $data_lesson->links('vendor.pagination.bootstrap-4') }}
                    </ul>
                  </nav>
                </div>
              </div>
