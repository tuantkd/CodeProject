  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="text-right">
          <a class="btn btn-primary" href="{!! URL::to('get_add_overview_admin') !!}"
          role="button">
            <i class="fas fa-plus-circle"></i>&nbsp;
            Thêm tài liệu báo cáo tổng quan
          </a>
        </div><br>
        ...
        method="GET" action="{{ route('view_overview_admin') }}">
        ...
        <div class="card mb-3">
          <div class="card-header" id="card-header">
            <h4><i class="fas fa-table"></i>&nbsp;Tài liệu báo cáo tổng quan</h4>
          </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <?php $i=1; ?>
                    @if(isset($data_overview))
                    @foreach($data_overview as $document)
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        href="get_edit_overview{!! $document->id !!}" role="button">
                      ...
                      <td>
                        ...
                        href="get_delete_overview{!! $document->id !!}" 
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <nav>
                    <ul class="pagination justify-content-end">
                         {{ $data_overview->links('vendor.pagination.bootstrap-4') }}
                    </ul>
                  </nav>
                </div>
              </div>
