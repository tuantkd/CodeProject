  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="text-right">
          <a class="btn btn-primary" href="{!! URL::to('get_add_curriculum_admin') !!}"
          role="button">
        ...
        method="GET" action="{{ route('view_curriculum_admin') }}">
        ...
        @if(session()->has('message'))
              <div class="alert alert-success" align="center" style="width: 30%;">
        ...
        <div class="card mb-3">
          <div class="card-header" id="card-header">
            <h4><i class="fas fa-table"></i>&nbsp;Tài liệu giáo trình</h4>
          </div>
          ...
          <div class="card-body" id="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php $i=1; ?>
                    @if(isset($data_curriculum))
                    @foreach($data_curriculum as $document)
            ...
            @php($users = DB::table('users')->where('id', $document->id_user_fk)->get())
                    <tr>
                      ...
                      <td>
                        ...
                        href="get_edit_curriculum{{ $document->id }}" role="button">
                      ...
                      <td>
                        ...
                        href="{!! URL::to('get_delete_curriculum'.$document->id ) !!}"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <nav>
                    <ul class="pagination justify-content-end">
                         {{ $data_curriculum->links('vendor.pagination.bootstrap-4') }}
                    </ul>
                  </nav>
                </div>
              </div>
