  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="text-right">
          <a class="btn btn-primary" href="{!! URL::to('get_add_book_admin') !!}"
          role="button">
            <i class="fas fa-plus-circle"></i>&nbsp;
            Thêm tài liệu sách mới
          </a>
        </div>
        ...
        method="GET" action="{{ route('view_book_admin') }}">
        ...
        <div class="card mb-3">
          ...
          <div class="card-header" id="card-header">
            <h4><i class="fas fa-table"></i>&nbsp;Tài liệu sách</h4>
          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-success" data-toggle="tooltip" title="Chỉnh sửa"
                          href="get_edit_book_admin{{ $document->id }}" role="button">
                      ...
                      <td>
                        <a data-toggle="tooltip" title="Xóa"
                          href="get_delete_book{!! $document->id !!}"
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <nav>
                    <ul class="pagination justify-content-end">
                         {{ $data_book->links('vendor.pagination.bootstrap-4') }}
                    </ul>
                  </nav>
                </div>
              </div>
