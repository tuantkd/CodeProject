@include('Admin2.header')
  ...
  <div class="container">
      ...
      <h2 align="center">Cập nhật tài liệu sách:</h2><br>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <form action="update_book_admin{!! $book->id !!}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            {!! method_field('PUT') !!}
            ...
            <div class="form-group">
                ...
                value="{!! $book->title_file !!}" name="txt_tieude_tailieu">
            </div>

            <div class="form-group">
                <h4>Nội dung tóm tắt:</h4>
                <textarea class="form-control" rows="3" name="txt_tomtat_tailieu">{!! $book->content !!}
                </textarea>
            </div>
            ...
            <div class="form-group">
              <h4>Tác giả:</h4>
                ...
                value="{!! $book->author !!}" name="txt_tacgia_tailieu">
            </div>

            <div class="form-group">
              <h4>Năm xuất bản:</h4>
                <input type="text" class="form-control" style="width: 50%;"
                value="{!! $book->publish !!}" name="txt_xuatban_tailieu">
            </div>

            <div class="form-group">
                <h4>Nguồn:</h4>
                <input type="text" class="form-control" style="width: 50%;"
                value="{!! $book->source !!}" name="txt_nguon_tailieu">
            </div>
            <hr>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <input type="file" value="{!! $book->file_name !!}" name="file_tailieu" id="file"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <input type="file" value="{!! $book->file_cover_image !!}" name="cover_image_tailieu" id="cover_image"/>
                </div>
            </div>
