@include('Admin2.header')
  ...
  <div class="container">
      ...
      <h2 align="center">Thêm tài liệu báo cáo chuyên đề:</h2><br>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          action="{{ route('post_add_thematic_admin') }}">
          ...
          <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
            ...
            <div class="form-group">
              <h4>Thể loại: Báo cáo chuyên đề</h4>
              <input type="hidden" name="txt_loai_tailieu" value="4">
            </div>
